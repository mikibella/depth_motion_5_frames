...
HEIGHT = 128
STEPSIZE = 1
INPUT_DIR = 'C:/Users/bellmi2/Documents/kitti/depth_selection/val_selection_cropped/image'
OUTPUT_DIR = 'C:/Users/bellmi2/Documents/kitti/depth_selection/val_selection_cropped/inference'
...
#     calib_raw = [get_line(file_calibration, 'P_rect_02'), get_line(file_calibration, 'P_rect_03')]
    ...
    for i in range(SEQ_LENGTH, len(files)+1, STEPSIZE):
        ...
        if os.path.exists(OUTPUT_DIR+'/' + imgnum + '.png'):
            ct+=1
            continue
    ...
    for i in range(SEQ_LENGTH, len(segs)+1, STEPSIZE):
        ...
        with gfile.Open(output_filepath, file_mode) as current_output_handle:
            ...
            current_output_handle.write(str(imgnum)+"\n")
